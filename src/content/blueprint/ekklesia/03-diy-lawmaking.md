---
id: ekklesia-diy-lawmaking
name: "DIY Government"
subtitle: "With Expert Help"
greekName: "Ψήφισμα"
blurb: "In AreTéCracy, any citizen can bring a law before the Assembly. Two expert bodies — the Aegis and IsoKratÓS — make sure the result is as good as the intent."
column: left
order: 2
---

In AreTéCracy, laws begin as **Hypotheses** — proposals brought before the Ekklesia by virtually any citizen or group of citizens, called Proponents, who have an idea and are willing to submit it through a carefully monitored process.

This is not a petition. It is not a suggestion box. It is the actual mechanism by which law is made.
...
**IsoKratÓS** supports the process at every stage: helping citizens develop and refine their Hypothesis before it reaches the floor, evaluating whether a proposal belongs in the Assembly it was submitted to, monitoring deliberation for logical fallacies and bad-faith argumentation, and performing both pre-session and real-time fact-checking.

The citizen brings the idea. The Aegis brings the expertise. IsoKratÓS keeps the process honest. The Assembly makes the decision.

*For the full law-making process: see The People's Laws hub.*
