...
name: "Isotimía"
greekName: "Ἰσοτιμία"
blurb: "The foundational principle that every citizen has the same civic worth and the same right to shape the shared world—not equal outcomes, but equal **standing** and access to self‑governance."
complexity: 1
category: concept
hasFullPage: true
relatedTerms: []
...
**See also:** The Four Aretai, The Four Isótēs, Isegoria, Isonomia, IsoEudaimonia
